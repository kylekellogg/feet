...
function love.conf(t)
	...
	t.window.title = ]]..flags.title..[[					-- The window title (string)
	t.window.icon = nil					-- Filepath to an image to use as the windows icon (string)
	t.window.width = ]]..flags.width..[[				-- The window width (number)
	t.window.height = ]]..flags.height..[[				-- The window height (number)
	t.window.borderless = false			-- Remove all border visuals from the window (boolean)
	t.window.resizable = false			-- Let the window be user-resizable (boolean)
	t.window.minwidth = ]]..flags.width..[[				-- Minimum window width if the window is resizable (number)
	t.window.minheight = ]]..flags.height..[[			-- Minimum window height if the window is resizable (number)
